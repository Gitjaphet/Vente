	...
	<body>
		...
		<div class="boom">
			<div class="container site">
				...
				file_put_contents('itrems.json', $jsonData);
			...
			<div class="cardo">
				<h4><i class="fas fa-shopping-bag"></i>  Panier  <i class="fas fa-shopping-bag"></i></h4>
			...
			<script>
				var items = <?php echo file_get_contents('itrems.json'); ?>.itrems;
			</script>
